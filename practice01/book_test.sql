...
insert into author(author_name, author_desc)
	values('이문열','경북 영양'),('박경리','경상남도 통영'),('유시민','17대 국회의원'),('기안84','기안동에서 산 84년생'),('강풀','온라인 만화가 1세대'),('김영하','알쓸신잡');

-- book테이블의 데이터 입력 쿼리문 9개
# 문제 이미지의 결과가 나오도록 데이터를 입력합니다.
insert into book(title, pubs, pub_date, author_id)
	values('우리들의 일그러진 영웅','다림','1998-02-22',1),('삼국지','민음사','2002-03-01',1),('토지','마로니에북스','2012-08-15',2),('유시민의 글쓰기 특강','생각의길','2015-04-01',3),('패션왕','중앙북스(books)','2012-02-22',4),('순정만화','재미주의','2011-08-03',5),('오직두사람','문학동네','2017-05-04',6),('26년','재미주의','2012-02-04',5),('자바의정석','열린책들','2015-10-20',null);
